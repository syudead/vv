...
（002）である。(1)〜(5) の結果を [research.md](./research.md) の「未解決事項の一覧」に
書き戻し、必要なら追従 PR を出す:
...
**期待**: ブランチ `claude/sdd-002-plan` に `specs/002-core-video-library/plan.md` 以下が
...
**期待**: 数分以内に routine の新しい run が始まり、`claude/sdd-002-tasks` の PR が開く。
それをマージすると `claude/sdd-002-implement-p1` の PR が開く。以後、フェーズごとに
...
**期待**: PR は開かず、Issue `sdd-next 停止: 002 phase-retry-limit` が 1 件立つ。もう一度
