...
- **要求者**: この feature を作ってほしいと言った人。質問を向ける相手であり、
  工程を動かしている人である。
- **利用者**: 出来上がったプロダクトを使う人。仕様の User Scenarios が扱う相手で
  あり、質問を向ける相手ではない。
...
見つかったらそれを仕様に書き、出所とともに「Settled Without Asking」の節に残す。
答えのある事項を質問に変えることは、要求者の注意を浪費する欠陥である。

「Settled Without Asking」は仮定の置き場ではない。要求者は目の前にいるのだから、
仕様が要求者の意図を推測して進むことはない。出所を書けない項目は、この節に入らず
質問になる。
