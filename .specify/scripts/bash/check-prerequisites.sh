...
# Get feature paths without writing session-local feature state. Issue handoff
# always supplies the directory explicitly; legacy feature.json reads remain
# available for compatibility when no explicit directory is supplied.
